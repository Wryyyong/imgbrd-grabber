...
export const source: ISource = {
    name: "E621",
    modifiers: ["order:id", "order:id_desc", "order:random", "order:score", "order:score_asc", "order:favcount", "order:favcount_asc", "order:tagcount", "order:tagcount_asc", "order:comment_count", "order:comment_count_asc", "order:comment_bumped", "order:comment_bumped_asc", "order:mpixels", "order:mpixels_asc", "order:filesize", "order:filesize_asc", "order:landscape", "order:portrait", "order:change", "order:duration", "order:duration_asc", "user:", "fav:", "voted:", "votedup:", "voteddown:", "approver:", "deletedby:", "commenter:", "noteupdater:", "id:", "score:", "favcount:", "comment_count:", "tagcount:", "gentags:", "arttags:", "chartags:", "copytags:", "spectags:", "invtags:", "lortags:", "metatags:", "rating:safe", "rating:s", "rating:questionable", "rating:q", "rating:explicit", "rating:e", "type:jpg", "type:png", "type:gif", "type:swf", "type:webm", "width:", "height:", "mpixels:", "ratio:", "filesize:", "status:pending", "status:active", "status:deleted", "status:flagged", "status:modqueue", "status:any", "date:", "source:", "description:", "note:", "delreason:", "ischild:true", "ischild:false", "isparent:true", "isparent:false", "parent:", "parent:none", "hassource:true", "hassource:false", "hasdescription:true", "hasdescription:false", "ratinglocked:true", "ratinglocked:false", "notelocked:true", "notelocked:false", "inpool:true", "inpool:false", "pending_replacements:true", "pending_replacements:false", "pool:", "set:", "md5:", "duration:"],
